...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    // Render
    const ImU32 col = ((held && hovered) ? ImColor(0, 255, 229, 255) : hovered ? ImColor(0, 255, 229, 255) : ImColor(23, 23, 23, 255));
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    window->DrawList->AddRectFilled(total_bb.Min, total_bb.Min + ImVec2(square_sz, square_sz), ImColor(32 / 255.0f, 33 / 255.0f, 35 / 255.0f, it_anim->second.selected_rect), 3.0f);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    // Render shape
    const ImU32 frame_col = (hovered ? ImColor(25, 25, 25, 255) : ImColor(3, 232, 252, 255));
    ...
    {
        ImU32 bg_col = ((popup_open || hovered) ? ImColor(255, 0, 230, 255) : ImColor(23, 23, 23, 255));
        ImU32 text_col = (ImGuiCol_Text);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    window->DrawList->AddRectFilled(frame_bb.Min, ImVec2(grab_bb.Min.x + 3, frame_bb.Max.y), ImColor(0, 247, 255), 5.0f);
